...
```{r lab_laquinta-code-dup2-demo, echo=TRUE,results='hide'}
dn_ak <- dn %>%
  filter(state == "AK")
nrow(dn_ak)
```
...
```{r lab_laquinta-code-demo, echo=TRUE, message=TRUE, warning=FALSE,results='hide'}
...
```{r lab_laquinta-example-example,eval=FALSE}
