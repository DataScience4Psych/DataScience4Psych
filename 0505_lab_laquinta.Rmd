...
In this lab, we will use the **tidyverse** and **dsbox** packages. The **dsbox** package is not on CRAN yet; instead it is hosted on GitHub. You will have to download and [install it yourself](https://github.com/tidyverse/dsbox#installation). This piece of code should help get you started.
...
```{r lab_laquinta-code-packages, echo=TRUE, message=FALSE}
library(tidyverse)
library(dsbox)
```
...
```{r lab_laquinta-solution_q7,eval=FALSE}
