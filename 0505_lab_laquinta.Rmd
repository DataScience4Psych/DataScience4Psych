...
If you cannot get `dsbox` to install, you can instead download the two datasets we will be using manually [here](https://github.com/DataScience4Psych/DataScience4Psych/raw/main/data/raw/laquinta.rda) and [here](https://github.com/DataScience4Psych/DataScience4Psych/raw/main/data/raw/dennys.rda).

```
githubURL_1 <- "https://github.com/DataScience4Psych/DataScience4Psych/raw/main/data/raw/laquinta.rda"

githubURL_2 <- "https://github.com/DataScience4Psych/DataScience4Psych/raw/main/data/raw/dennys.rda"
...
<!-- make the instructions harder to misintreption, because we want to avoid having people break the function without discouring them from exploring -->
...
```{r echo=FALSE, message=FALSE, eval=T, warning=FALSE, cache=TRUE}
library(ggridges)
...
```{r message=FALSE, warning=FALSE, echo=TRUE, error=TRUE, cache=TRUE}
