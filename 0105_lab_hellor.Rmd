...
The first goal of this lab is to introduce you to R and RStudio. We will be using them throughout the course:
...
To make versioning simpler, this lab is a solo lab. I want to make sure everyone gets a substanstial amount of time at the steering wheel, working directly with R.

# Lab: Aloha R! {#lab01aloha}

## Getting started {-}

Each of your assignments will begin with the following steps. They're outlined in detail here. Going forward, each lab will start with a "Getting started" section, but details will be a bit more sparse than this. You can always refer back to this lab for a detailed list of the steps involved in getting started with an assignment.
...
* First, you need to be logged into your GitHub account. If you don't have one, you can create one [here](https://github.com/join), using your university email address.
