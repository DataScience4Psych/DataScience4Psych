...
```{r opener-include-3, echo=FALSE,eval = knitr::is_latex_output()}
embed_youtube_alt("dc3D2tbl8G0")
```
```{r opener-include-4, echo=FALSE,eval = knitr::is_html_output()}
...
```{r opener-include-5, echo=FALSE,eval = knitr::is_latex_output()}
embed_youtube_alt("ZbGMbdDLnyY")
```
```{r opener-include-6, echo=FALSE,eval = knitr::is_html_output()}
...
```{r opener-include-7, echo=FALSE,eval = knitr::is_latex_output()}
embed_youtube_alt("1IOCKxgowaQ")
```
```{r opener-include-8, echo=FALSE,eval = knitr::is_html_output()}
...
```{r opener-include-9, echo=FALSE,eval = knitr::is_latex_output()}
embed_youtube_alt("Fq_hAQd78zo")
```
```{r opener-include-10, echo=FALSE,eval = knitr::is_html_output()}
