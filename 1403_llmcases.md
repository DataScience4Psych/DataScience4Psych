...
You can follow along with the slides [here][d32_llmapplications] if you would like to open them full-screen.



<iframe src="https://datascience4psych.github.io/slides/d32_llmapplications/d32_llmapplications.html" width="672" height="400px" data-external="1"></iframe>
...
<img src="1403_llmcases_files/figure-html/unnamed-chunk-4-1.png" alt="" width="672" />
...
# Generate a sentence
generate_text("the")
#> [1] "the quick brown fox jumps over the quick brown fox jumps"
```
