...
```{r apiwrappers-code-packages, message = FALSE, warning = FALSE,error=TRUE}
library(tidyverse)
library(kableExtra)
library(rebird)
```
...
```{r apiwrappers-code-demo, eval = TRUE,error=TRUE, cache=TRUE}
...
```{r apiwrappers-code-demo, results = 'asis', eval = TRUE,error=TRUE,cache=TRUE}
...
```{r apiwrappers-code-packages, eval = TRUE,error=TRUE,cache=TRUE}
...
```{r apiwrappers-setup-config, include=FALSE,error=TRUE}
...
```{r apiwrappers-code-packages, message = FALSE, warning = FALSE, eval = TRUE,error=TRUE}
...
```{r apiwrappers-code-dup2-demo, eval = TRUE,error=TRUE}
...
```{r apiwrappers-code-demo, eval = TRUE,cache=TRUE,error=TRUE}
...
```{r apiwrappers-code-packages, eval = TRUE,error=TRUE}
nrow(rio_english)
nrow(rio_portuguese)
```
...
```{r apiwrappers-code-dup2-packages,error=TRUE}
...
```{r apiwrappers-code-dup2-demo,error=TRUE}
gender("Kelsey")
...
```{r apiwrappers-code-dup2-demo,error=TRUE, cache=TRUE,error=TRUE}
gender("Mason")
