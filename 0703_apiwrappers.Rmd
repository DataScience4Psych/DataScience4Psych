...
```{r apiwrappers-code-1, eval = TRUE,error=TRUE}
...
```{r apiwrappers-code-2, eval = TRUE,error=TRUE}
...
```{r apiwrappers-code-3,error=TRUE}
...
```{r apiwrappers-code-4,error=TRUE}
gender("Kelsey")
...
```{r apiwrappers-code-5,error=TRUE, cache=TRUE,error=TRUE}
gender("Mason")
