...
if(exists("admin/secrets/ebird_api_key.txt")){
...
if (is.null(ebirdkey) || ebirdkey == "") {
  warning("No eBird API key found. Please set your API key in 'admin/secrets/ebird_api_key.txt' or as an environment variable 'EBIRD_API_KEY'.")
...
```{r links-external, child="admin/md/links.md"}
```
