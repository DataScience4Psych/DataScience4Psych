...
```{r apiwrappers-load-usethis, message = FALSE, warning = FALSE, eval = TRUE,error=TRUE}
...
```{r apiwrappers-demo-geonames-country, eval = geonamesUsername_available,error=TRUE}
...
```{r apiwrappers-demo-wiki-rio,eval = geonamesUsername_available,error=TRUE}
...
```{r apiwrappers-demo-wiki-nrow, eval = geonamesUsername_available,error=TRUE}
nrow(rio_english)
nrow(rio_portuguese)
```
...
```{r apiwrappers-load-gender,error=TRUE}
