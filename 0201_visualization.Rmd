...
This module is designed to introduce you to exploratory and graphical data analysis. Please watch the videos and work your way through the notes. **The videos start on the next page.**  You can find the video playlist for this module [here][ds4p-pl-02]. The slides used to make the videos in this module can be found in the [slides repo][ds4p-slides].
...
```{r, echo=FALSE}
include_tweet("https://twitter.com/valeriepolad/status/1388733898926870533")
```
