...
```{r, echo=FALSE}
# Filler Video
video_url="https://www.youtube.com/watch?v=J6arziOCQpk"
embed_url(video_url) %>%
  use_align("center")
```
...
```{r, echo=FALSE}
video_url="https://www.youtube.com/watch?v=E5IY1FQv0OM"
embed_url(video_url) %>%
  use_align("center")
```
...
video_url="https://www.youtube.com/watch?v=-tdEQXdx-SA"
embed_url(video_url) %>%
  use_align("center")
```
...
```{r, echo=FALSE}
# Aesthetics 
video_url="https://www.youtube.com/watch?v=K2u2_lcgdks"
embed_url(video_url) %>%
  use_align("center")
```
...
## Introduction to visualizing numerical data
...
video_url="https://www.youtube.com/watch?v=7OWyhBWMoM8"
embed_url(video_url) %>%
  use_align("center")
```
...
var_url=slide_url(ds4p_urls,"d05_viznum","#12")
include_url(var_url, height = "400px")
```
...
video_url="https://www.youtube.com/watch?v=xY819zNKdnY"
embed_url(video_url) %>%
  use_align("center")
```
...
var_url=slide_url(ds4p_urls,"d06_vizcat")
include_url(var_url, height = "400px")
```
