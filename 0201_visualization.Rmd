...
Total length of playlist : 2 hours, 2 minutes, 11 seconds
  ...
  * At 1.25x : 1 hour, 37 minutes, 44 seconds

  * At 1.50x : 1 hour, 21 minutes, 27 seconds
...
You can follow along with the slides [here][d05_viznum] if they do not appear below. Fun fact, when you screen capture with [f.lux](https://justgetflux.com/) running in the background, f.lux is captured too.
