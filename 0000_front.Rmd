...
```{r front-include-1, message = FALSE, warning = FALSE, echo = FALSE}
...
```
<!--
```{r front-include-2,echo=FALSE, eval = knitr::is_html_output(),error=FALSE}
# Gromit Placing Rail Tracks for 10 Hours
"https://www.youtube.com/watch?v=fwJHNw9jU_U" %>%
  embed_url() %>%
  use_align("center")
```
```{r front-include-3,echo=FALSE, eval = knitr::is_latex_output()}
# Gromit Placing Rail Tracks for 10 Hours
embed_youtube_alt("fwJHNw9jU_U")
```
-->
...
```{r front-include-4, message = FALSE, warning = FALSE, echo = FALSE}
ds4p_status %>%
  DT::datatable(
    rownames = FALSE,
...
```{r front-include-5, message = FALSE, warning = FALSE, echo = FALSE,error=TRUE}
ds4p_urls %>%
  mutate(
...
```{r front-include-6, message = FALSE,error=TRUE, warning = FALSE, echo = FALSE}
...
```{r front-include-7, message = FALSE,error=TRUE, warning = FALSE, echo = FALSE}
session$packages %>%
