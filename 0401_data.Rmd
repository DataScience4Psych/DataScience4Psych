...
# LEC: Data types and recoding


```{r embed-data-tweets, echo=FALSE}
...
```{r datatypes-intro-video-html, echo=FALSE}
# 04.01
...
```{r embed-datatypes-intro-slides, echo=FALSE}
...
```{r datatypes-video-html, echo=FALSE}
#
...
```{r embed-datatypes-slides, echo=FALSE}
slide_url(ds4p_urls, "d11_types", "#17") %>%
  include_url(height = "400px")
```
