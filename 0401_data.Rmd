...
```{r, echo=FALSE}
try(include_tweet("https://twitter.com/IsabellaGhement/status/1473649548778106889"))

try(include_tweet("https://twitter.com/patilindrajeets/status/1476171334400954371"))
```
