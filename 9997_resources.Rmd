...
```{r resources-include-1, echo=FALSE}
...
```{r resources-include-2, echo=FALSE}
# Are you a student? If yes, this is the best data science project for you!
...
```{r resources-include-6, echo=FALSE}
...
```{r resources-include-7, echo=FALSE}
## Quantum Computers Explained
...
```{r resources-include-8, echo=FALSE}
# Quantum Computers Explained
...
```{r resources-include-9, echo=FALSE}
# Emergence – How Stupid Things Become Smart Together
...
```{r resources-include-12, echo=FALSE}
...
```{r resources-include-13, echo=FALSE}
...
```{r resources-include-14, echo=FALSE}
