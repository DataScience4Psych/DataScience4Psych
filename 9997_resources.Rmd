...
```{r resources-setup, include = FALSE}
source("common.R")
...
```{r resources-include-tweet-vismlm, echo=FALSE}
...
```{r resources-include-video-datastudent, echo=FALSE}
# Are you a student? If yes, this is the best data science project for you!
...
```{r resources-include-video-coding-math, echo=FALSE}
...
```{r resources-include-video-quantum, echo=FALSE}
## Quantum Computers Explained
...
```{r resources-include-video-automation, echo=FALSE}
# Quantum Computers Explained
...
```{r resources-include-video-emergence, echo=FALSE}
# Emergence – How Stupid Things Become Smart Together
...
```{r resources-include-tweet-help, echo=FALSE}
try_include_tweet("https://twitter.com/juliasilge/status/1477777715453329408")
```

## The Birthday Paradox

```{r resources-include-video-birthday, echo=FALSE}
# The Birthday Paradox
...
```{r resources-include-video-divide-zero, echo=FALSE}
...
```{r resources-include-tweet-coding-kitty, echo=FALSE}
...
```{r resources-include-tweet-smason, echo=FALSE}
