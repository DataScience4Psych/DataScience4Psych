...
embed_tweet("https://twitter.com/datavisFriendly/status/1365801123584565249")
```
...
embed_tweet("https://twitter.com/Emil_Hvitfeldt/status/1356468455101227009")
```
...
embed_tweet("https://twitter.com/CodeWisdom/status/1358724807525871617")
```
...
embed_tweet("https://twitter.com/juliasilge/status/1477777715453329408")
```
...
```{r, echo=FALSE}
embed_tweet("https://twitter.com/jepusto/status/1471297801506234368")
...
```{r, echo=FALSE}
embed_tweet("https://twitter.com/SMasonGarrison/status/1372640164493856773")
```
