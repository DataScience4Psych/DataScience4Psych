...
```{r lab_zdravor-example-1, eval = FALSE}
...
```{r lab_zdravor-code-1, message=FALSE}
library(tidyverse)
library(datasauRus)
```
...
```{r lab_zdravor-code-4, exercise3}
# code goes here
```
