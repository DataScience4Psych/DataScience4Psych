...
```{r, echo=FALSE}
# 07
video_url="https://www.youtube.com/watch?v=hnUGwlyqx1M"
embed_url(video_url) %>%
  use_align("center")
```
...
```{r, echo=FALSE}
var_url=slide_url(ds4p_urls,"d12_import")
...
```{r, echo=FALSE}
var_url=slide_url(ds4p_urls,"d12_import","#9")
include_url(var_url, height = "400px")
```
...
```{r, echo=FALSE}
# 08
video_url="https://www.youtube.com/watch?v=g7G8ZTnDSv8"
embed_url(video_url) %>%
  use_align("center")
```
...
```{r, echo=FALSE}
var_url=slide_url(ds4p_urls,"d12_import","#17")
include_url(var_url, height = "400px")
```
...
```{r, echo=FALSE}
var_url=slide_url(ds4p_urls,"d12_import","#22")
include_url(var_url, height = "400px")
```
...
```{r, echo=FALSE}
# :D
video_url="https://www.youtube.com/watch?v=EmB1yyzRX0c"
embed_url(video_url) %>%
  use_align("center")
```
...
```{r, echo=FALSE}
var_url=slide_url(ds4p_urls,"d12_import","#30")
include_url(var_url, height = "400px")
```
