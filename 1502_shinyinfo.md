...
[Shiny](https://shiny.rstudio.com) is a package from RStudio that can be used to build interactive web pages with R. While that may sound scary because of the words "web pages", Shiny is geared to R users who have zero experience with web development, and you do not need to know any HTML/CSS/JavaScript.

You can do quite a lot with Shiny: think of it as an easy way to make an interactive web page, and that web page can seamlessly interact with R and display R objects (plots, tables, or anything else you do in R). To get a sense of the wide range of things you can do with Shiny, you can visit my Shiny server ([https://daattali.com/shiny/](https://daattali.com/shiny/)), which hosts some of my own Shiny apps.

This tutorial is a hands-on activity complement to a set of presentation slides for learning how to build Shiny apps. In this activity, we'll walk through all the steps of building a Shiny app using a dataset that lets you explore the products available at the BC Liquor Store. The final version of the app, including a few extra features that are left as exercises for the reader, can be seen here: [https://daattali.com/shiny/bcl/](https://daattali.com/shiny/bcl/). Any activity deemed as an exercise throughout this tutorial is not mandatory for building our app, but they are good for getting more practice with Shiny.

This tutorial should take approximately an hour to complete. If you want even more practice, another great tutorial is the [official Shiny tutorial](https://shiny.rstudio.com/tutorial/). RStudio also provides a [handy cheatsheet]() to remember all the little details after you already learned the basics.
...
RStudio provides a service called [shinyapps.io](https://www.shinyapps.io) which lets you host your apps for free. It is integrated seamlessly into RStudio so that you can publish your apps with the click of a button, and it has a free version. The free version allows a certain number of apps per user and a certain number of activity on each app, but it should be good enough for most users. It also lets you see some basic stats about the usage of your app.

Hosting your app on shinyapps.io is the easy and recommended way of getting your app online. Go to [www.shinyapps.io](https://www.shinyapps.io) and sign up for an account. When you're ready to publish your app, click on the "Publish Application" button in RStudio and follow the instructions. You might be asked to install a couple of packages if it's your first time.
...
The other option for hosting your app is on your own private [Shiny Server](https://www.rstudio.com/products/shiny/shiny-server/). Shiny Server is also a product by RStudio that lets you host apps on your own server. This means that instead of RStudio hosting the app for you, you have it on your own private server. This gives you a lot more freedom and flexibility, but it also means you need to have a server and be comfortable administering a server. Some people, such as Dean Attali, host all their apps on [their own Shiny Server](https://daattali.com/shiny/) just because they like having the extra control, but when they first learned about Shiny they used [shinyapps.io] for several months.

If you're feeling adventurous and want to host your own server, you can follow [this tutorial for hosting a Shiny Server](https://deanattali.com/2015/05/09/setup-rstudio-shiny-server-digital-ocean/).
...
If you do want to add some JavaScript or use common JavaScript functions in your apps, you might want to check out [`shinyjs`](https://deanattali.com/shinyjs/).
...
* [Publish your apps for free with shinyapps.io](https://www.shinyapps.io)
* [Host your app on your own Shiny server](https://deanattali.com/2015/05/09/setup-rstudio-shiny-server-digital-ocean/)
* [Learn about how reactivity works](https://shiny.rstudio.com/articles/understanding-reactivity.html)
...
* [shinythemes](https://rstudio.github.io/shinythemes/) - Easily alter the appearance of your app ([cran](https://CRAN.R-project.org/package=shinythemes)).
* [shinyjs](https://deanattali.com/shinyjs/) - Enhance user experience in Shiny apps using JavaScript functions without knowing JavaScript ([cran](https://CRAN.R-project.org/package=shinyjs); [GitHub](https://github.com/daattali/shinyjs)).
* [leaflet](https://rstudio.github.io/leaflet/) - Add interactive maps to your apps ([cran](https://CRAN.R-project.org/package=leaflet); [GitHub](https://github.com/rstudio/leaflet)).
* [ggvis](https://ggvis.rstudio.com) - Similar to ggplot2, but the plots are focused on being web-based and more interactive ([cran](https://CRAN.R-project.org/package=ggvis)).
* [shinydashboard](https://rstudio.github.io/shinydashboard/) - Gives you tools to create visual "dashboards" ([cran](https://CRAN.R-project.org/package=shinydashboard); [GitHub](https://github.com/rstudio/shinydashboard)).
