...
> Note: See the sidebar [here](https://collections.ed.ac.uk/art) and note that there are `r num_piececs` pieces in the art collection we're collecting data on.
...
> **Reminder:** The collection has `r num_piececs` pieces in total.
...
`r num_piececs` rows and 3 columns.
