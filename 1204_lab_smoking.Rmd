...
In this portion of the analysis, we focus on two variables. The first one is `mature`, which classifies mothers as either "younger" or "mature."

The second variable is `lowbirthweight`, a binary indicator of whether the baby’s birth weight was classified as "low."

In the following exercises, you’ll determine how `mature` is constructed and then test whether the rate of low birth weight differs between the two age groups.
