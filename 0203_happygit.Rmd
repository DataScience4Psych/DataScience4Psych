...
```{r include-github-git-basics, child = './includes/basicsofgithubandgit.Rmd'}
```
...
```{r include-half-battle-content, child = './includes/halfthebattle.Rmd'}
```
...
```{r include-git-install, child = './includes/installgit.Rmd'}
```
...
```{r include-git-client-rationale, child = './includes/whygitclient.Rmd'}
```
...
```{r include-git-client-install, child = './includes/installgitclient.Rmd'}
```
