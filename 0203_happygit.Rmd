...
```{r happygit-setup, include=FALSE}
source("common.R")
```

```{r embed-git-tweet, echo=FALSE}
...
```{r include-github-git-basics, child = './supporting-docs/basicsofgithubandgit.Rmd'}
```
...
```{r include-half-battle-content, child = './supporting-docs/halfthebattle.Rmd'}
```
...
```{r include-git-install, child = './supporting-docs/installgit.Rmd'}
```
...
```{r configure-git-usethis, eval = FALSE}
...
```{r include-git-client-rationale, child = './supporting-docs/whygitclient.Rmd'}
```
...
```{r include-git-client-install, child = './supporting-docs/installgitclient.Rmd'}
```
