...
```{r happygit-include-1, echo=FALSE}
...
```{r happygit-child-1, child = './supporting-docs/basicsofgithubandgit.Rmd'}
```
...
```{r happygit-child-2, child = './supporting-docs/halfthebattle.Rmd'}
```
...
```{r happygit-child-3, child = './supporting-docs/installgit.Rmd'}
```
...
```{r happygit-example-1, eval = FALSE}
...
```{r happygit-child-4, child = './supporting-docs/whygitclient.Rmd'}
```
...
```{r happygit-child-5, child = './supporting-docs/installgitclient.Rmd'}
```
