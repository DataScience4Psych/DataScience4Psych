...
```{r cv-include-video, echo=FALSE,eval = knitr::is_latex_output()}
embed_youtube_alt("U70OmbO-DP4")
```
```{r cv-include-video, echo=FALSE,eval = knitr::is_html_output()}
...
```{r cv-include-slides, echo=FALSE}
...
```{r cv-include-content, echo=FALSE}
