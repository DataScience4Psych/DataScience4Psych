...
```{r cv-include-1, echo=FALSE, eval=FALSE}
...
```{r cv-include-3, echo=FALSE,eval = knitr::is_latex_output()}
embed_youtube_alt("U70OmbO-DP4")
```
```{r cv-include-4, echo=FALSE,eval = knitr::is_html_output()}
"https://www.youtube.com/watch?v=U70OmbO-DP4" %>%
  embed_url() %>%
  use_align("center")
```

```{r cv-include-5, echo=FALSE}
...
```{r cv-include-6, echo=FALSE,eval = knitr::is_latex_output()}
embed_youtube_alt("R4h9u-sQHwI")
```
```{r cv-include-7, echo=FALSE,eval = knitr::is_html_output()}
"https://www.youtube.com/watch?v=R4h9u-sQHwI" %>%
  embed_url() %>%
  use_align("center")
```

```{r cv-include-8, echo=FALSE}
