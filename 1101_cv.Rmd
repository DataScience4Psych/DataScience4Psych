...
try(include_tweet("https://twitter.com/Chops310/status/1382481152489979913"))
```
...
```{r, echo=FALSE}
"https://datascience4psych.github.io/slides/d25_crossvalidation/d25_crossvalidation.html" %>%
include_url(height = "400px")
```
...
```{r, echo=FALSE}
"https://datascience4psych.github.io/slides/d25_crossvalidation/d25_crossvalidation.html#35" %>%
include_url( height = "400px")
```
