...
Welcome to class! This website is designed to accompany Mason Garrison's Data Science for Psychologists (DS4P). DS4P is a graduate-level methods course at Wake Forest University. This website is both the syllabus and primary lecture materials. All the embedded lecture videos can be found on a [youtube playlist](https://www.youtube.com/playlist?list=PLKrrdtYgOUYbWGmSnbLIYwdLOnGm6une6)
...
<iframe width="560" height="315" src="http://www.youtube.com/embed/HU39nOxcJYg?rel=0" frameborder="0" allowfullscreen></iframe>
...
<sentence of difference between minimum, recommended, and mason. Minimum is the bare minimum that you need to function in the class. 
Recommended are the what I think you need in order to succeed. Mason are the levels that I am currently using. In general what I am using is beyond what any reasonable person needs. I include it primarily as a curiosity and more evidence of my "too-muchness">
