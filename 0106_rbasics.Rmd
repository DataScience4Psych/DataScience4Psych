# LEC: R basics and workflows {#r_basics}
...
```{r include-workspace-tweet, echo=FALSE}
...
```{r embed-tradition-video-latex, echo=FALSE,eval = knitr::is_latex_output()}
embed_youtube_alt("gRdfX7ut8gw")
```
```{r embed-tradition-video-html, echo=FALSE,eval = knitr::is_html_output()}
