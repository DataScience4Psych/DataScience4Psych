...
```{r functions-include-video, echo=FALSE}
...
```{r functions-include-video, echo=FALSE,eval = knitr::is_latex_output()}
embed_youtube_alt("gfmVLvgztSw")
```

```{r functions-include-video, echo=FALSE,eval = knitr::is_html_output()}
...
```{r functions-include-slides, echo=FALSE}
