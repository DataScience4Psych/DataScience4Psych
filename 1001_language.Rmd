...
```{r language-include-1, echo=FALSE,eval = knitr::is_latex_output()}
embed_youtube_alt("XbyXxGDFmFQ")
```
```{r language-include-2, echo=FALSE,eval = knitr::is_html_output()}
"https://www.youtube.com/watch?v=XbyXxGDFmFQ" %>%
  embed_url() %>%
  use_align("center")
```

```{r language-include-3, echo=FALSE}
...
```{r language-include-4, echo=FALSE,eval = knitr::is_latex_output()}
embed_youtube_alt("Y0ehX5VI_Wo")
```
```{r language-include-5, echo=FALSE,eval = knitr::is_html_output()}
"https://www.youtube.com/watch?v=Y0ehX5VI_Wo" %>%
  embed_url() %>%
  use_align("center")
```

```{r language-include-6, echo=FALSE}
