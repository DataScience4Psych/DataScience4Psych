...
```{r language-include-video-intro, echo=FALSE,eval = knitr::is_latex_output()}
embed_youtube_alt("XbyXxGDFmFQ")
```
```{r language-include-video-intro-html, echo=FALSE,eval = knitr::is_html_output()}
"https://www.youtube.com/watch?v=XbyXxGDFmFQ" %>%
  embed_url() %>%
  use_align("center")
```

```{r language-include-slides-intro, echo=FALSE}
...
```{r language-include-video-modeling, echo=FALSE,eval = knitr::is_latex_output()}
embed_youtube_alt("Y0ehX5VI_Wo")
```
```{r language-include-video-modeling-html, echo=FALSE,eval = knitr::is_html_output()}
