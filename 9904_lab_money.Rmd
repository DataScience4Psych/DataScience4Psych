...
```{r lab_money-setup, include = FALSE}
source("common.R")
ds4p_urls <- read.csv("./metadata/ds4p_urls.csv")
```

```{r lab_money-libraries, include=FALSE}
library(tidyverse)
library(robotstxt)
...
```{r lab_money-fig-screenshot, echo=FALSE, out.width="100%", fig.fullwidth = TRUE}
