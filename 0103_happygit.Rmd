...
# ODD: Getting Started with Github {#happygit}
This optional deep dive (ODD) is in part adapted from Jenny Bryan's [happygitwithr](https://happygitwithr.com/). I encourage you to check out the unabridged version as it has so much more detail.
