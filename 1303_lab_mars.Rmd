...
1. We'll start by simulating the age of our colonists. Age is a crucial factor in colony planning as it impacts the skill diversity, potential for growth, and the sustainability of the colony.  Age will be simulated using a normal distribution, which is a common method for modeling age in populations.
...
hist(age, main="Histogram of Colonist Ages", xlab="Age", breaks=10, col="darkblue")
```

Analyze the histogram of the age distribution that you've generated. How does the distribution of ages reflect the needs of a Mars colony?
