...
1.B. Consider the histograms of the age distribution that we've generated (as well as two more I added). 

How does the distribution of ages reflect the needs of a Mars colony? Given this distribution how unusual would it be to have a colonist who was `r round(as.numeric(difftime(Sys.Date(), as.Date("1971-06-28"), units = "days")) / 365.25, digits = 1)` years old?



1.C. Add a uniformally-distributed variable to your colonists.

Now, let's simulate data from another attribute. Unlike, age, this variable follows a uniform distribution. For a uniform distribution,  Obviously, this variable is a critical factor in the success of our Mars colony.
...
Simulate data from a uniform distribution. Now, let's simulate data from another attribute: VARIABLE. VARIABLE is a critical factor in the success of our Mars colony. We'll simulate health scores for our colonists using a uniform distribition.



#### Task 2: Skill Correlations
