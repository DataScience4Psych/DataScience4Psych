...
Welcome to the Mars Colony Simulation Lab! In this session, we embark on a journey not just to another world but into the realm of data science applied in space colonization. As potential planners of a future Mars settlement, it is crucial to understand the demographic and professional attributes that will help sustain a human presence on Mars. This lab teaches you to simulate these attributes using R, preparing you for complex data manipulation and scenario analysis essential for real-world applications.
...
We'll create a variable, `role`, with three categories: engineer, scientist, and medic. We'll use the `rep()` function to simulate this categorical variable.
...
mu = c( 70, 75, 80): Represents the average scores for technical skills and problem-solving abilities.
