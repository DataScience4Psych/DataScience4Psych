...
```{r lab_mars-include-content,echo=FALSE}
set.seed(100)
...
```{r lab_mars-include-content,echo=FALSE,message=FALSE}
library(viridis)
# Fit a linear model
...
```{r exercise-one-part-one, error=TRUE}
...
```{r lab_mars-include-content,echo=FALSE,message=FALSE, warnings=FALSE}
# Fit a linear model
...
```{r lab_mars-include-content, exercise-2-solution.2plot, error=TRUE, echo=FALSE,warning=FALSE,message=FALSE}
...
<details> 
  <summary>Click this text for forloop based solution</summary>
```{r ref.label = "exercise-5-solutionsolution", echo = TRUE, warning = FALSE, message=FALSE}
```
</details>
</details>
