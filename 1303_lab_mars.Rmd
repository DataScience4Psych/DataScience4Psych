...
```{r lab_mars-include-1,echo=FALSE}
set.seed(100)
...
```{r lab_mars-code-2, ref.label = "reptables", echo = TRUE, warning = FALSE}
```
</details>
...
```{r lab_mars-include-2,echo=FALSE,message=FALSE}
library(viridis)
# Fit a linear model
...
```{r lab_mars-include-3,echo=FALSE,message=FALSE, warnings=FALSE}
# Fit a linear model
...
```{r lab_mars-include-4, exercise2.2plot, error=TRUE, echo=FALSE,warning=FALSE,message=FALSE}
