...
```{r load-packages, message=FALSE, warning=FALSE, cache=FALSE}
...
```{r lab_mars-include-scatterplot2,echo=FALSE,message=FALSE, warnings=FALSE}
# Fit a linear model
...
<details>
  ...
  If you're stuck, you can check the source code for the solution by examining the following chuck in this corresponding rmd file exercise-2-solution.2solution.
</details>
