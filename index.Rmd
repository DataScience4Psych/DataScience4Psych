...
In terms of timing, I will have each module completed by the start of the week. Given that the class meets either on Monday or Friday, the start of the "week" will be Wednesday. It is likely that I will get ahead of this deadline. You can see the current status of the course below.
...
* Learning R 
* functions
* [fun, unusual ways of presenting](#portfolio)
