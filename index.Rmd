...
cat('
<iframe width="560" height="315" src="https://www.youtube.com/embed/nYYJmmcgzr8?rel=0" frameborder="0" allowfullscreen></iframe>
')
```
```{r}
library("vembedr")
...
![](https://www.youtube.com/embed/HU39nOxcJYg?rel=0)
