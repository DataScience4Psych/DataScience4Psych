...
This module is designed to orient you to the class. Please watch the videos and work your way through the notes. Although the videos are embedded into the course course, you can find the video playlist [here](https://www.youtube.com/playlist?list=PLKrrdtYgOUYaEAnJX20Ryy4OSie375rVY). 
...
```{r, echo=FALSE}
library(vembedr)
embed_url("https://www.youtube.com/watch?v=HU39nOxcJYg?rel=0") %>%
  use_align("center")
```
...
```{r, echo=FALSE}
embed_url("https://www.youtube.com/watch?v=dc3D2tbl8G0?rel=0") %>%
  use_align("center")
```
