...
slide_url(ds4p_urls, "d02_toolkit", "#28") %>%
...
slide_url(ds4p_urls, "d02_toolkit", "#32") %>%
  include_url(height = "400px")
```
...
slide_url(ds4p_urls, "d02_toolkit", "#43") %>%
  include_url(height = "400px")
```
...
```{r embed-getting-learn, echo=FALSE,error=TRUE}
slide_url(ds4p_urls, "d02_toolkit","#49") %>%
  include_url(height = "400px")
```
