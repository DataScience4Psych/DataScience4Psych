...
```{r workflow-include-1, echo=FALSE,eval = knitr::is_html_output()}
"https://www.youtube.com/watch?v=fIhIqTy8PVw" %>%
  embed_url() %>%
  use_align("center")
```
```{r workflow-include-2,echo=FALSE, eval = knitr::is_latex_output()}
embed_youtube_alt("fIhIqTy8PVw")
```

But, if you are in the mood to be entertained, start the video from the beginning.

```{r workflow-include-3, echo=FALSE,eval = knitr::is_html_output()}
"https://www.youtube.com/watch?v=r5dlYNLIG4E" %>%
  embed_url() %>%
  use_align("center")
```
```{r workflow-include-4,echo=FALSE, eval = knitr::is_latex_output()}
...
```{r workflow-include-5, echo=FALSE}
...
```{r workflow-include-6, echo=FALSE,eval = knitr::is_latex_output()}
embed_youtube_alt("RIOp8biwBZ4")
```
```{r workflow-include-7, echo=FALSE,eval = knitr::is_html_output()}
...
```{r workflow-include-8, echo=FALSE}
...
```{r workflow-include-9, echo=FALSE,eval = knitr::is_latex_output()}
embed_youtube_alt("w3jLJU7DT5E")
```
```{r workflow-include-10, echo=FALSE,eval = knitr::is_html_output()}
...
```{r workflow-include-11, echo=FALSE,eval = knitr::is_latex_output()}
embed_youtube_alt("O2wfi7Z0Py4")
```
```{r workflow-include-12, echo=FALSE,eval = knitr::is_html_output()}
"https://www.youtube.com/watch?v=O2wfi7Z0Py4" %>%
  embed_url() %>%
  use_align("center")
```

```{r workflow-include-13, echo=FALSE}
