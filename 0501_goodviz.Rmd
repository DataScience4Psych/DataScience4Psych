...
```{r, echo=FALSE}
library(tweetrmd)
embed_tweet("https://twitter.com/ChelseaParlett/status/1361516386925744129")


embed_tweet("https://twitter.com/joshuadarr/status/1466150736283242498")
```
...
```{r, echo=FALSE}
embed_tweet("https://twitter.com/mijkenijk/status/1365913365755822089")
```
