...
```{r, echo=FALSE}
library(tweetrmd)
try(include_tweet("https://twitter.com/ChelseaParlett/status/1361516386925744129"))


try(include_tweet("https://twitter.com/joshuadarr/status/1466150736283242498"))
```
...
```{r, echo=FALSE}
try(include_tweet("https://twitter.com/Notawful/status/1457441237787676672?s=20"))
```
...
```{r, echo=FALSE}
try(include_tweet("https://twitter.com/mijkenijk/status/1365913365755822089"))
```
