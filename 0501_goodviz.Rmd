...
* Suggested Readings
  ...
  * [Nature's Research Figure Guide: Top 10 ways to delay your paper](https://research-figure-guide.nature.com/figures/top-10-ways-to-delay-your-paper/)
...
# LEC: Designing effective visualizations
...
slide_url(ds4p_urls, "d13_goodviz", "#9") %>%
  include_url(height = "400px")
```
