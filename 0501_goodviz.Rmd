...
```{r goodviz-include-1, echo=FALSE}
library(tweetrmd)
...
```{r goodviz-include-2, echo=FALSE}
# Designing effective visualizations
...
```{r goodviz-include-3, echo=FALSE}
...
```{r goodviz-include-4, echo=FALSE}
# Principles for effective visualizations
...
```{r goodviz-include-5, echo=FALSE}
slide_url(ds4p_urls, "d13_goodviz", "#7") %>%
  include_url(height = "400px")
```

```{r goodviz-include-6, echo=FALSE}
