<!-- source: https://github.com/jennybc/happy-git-with-r/blob/master/install-git-client.Rmd -->

# ODD: Install a Git client {#git-client}

This is optional deep dive on Git but it is **highly recommended**.
