...
Bonus slides [here](https://datascience4psych.github.io/slides/d19_bias/d19_bias.html) if they do not appear below.
...
```{r, echo=FALSE}
"https://twitter.com/cfiesler/status/1485423667588780033" %>%
include_tweet()
```
...
```{r, echo=FALSE}
try(include_tweet("https://twitter.com/_KarenHao/status/1381981018295578629"))

try(include_tweet("https://twitter.com/JAldrichPL/status/1451524487275552775"))
```
