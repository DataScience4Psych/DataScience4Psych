...
```{r, echo=FALSE}
embed_tweet("https://twitter.com/cfiesler/status/1485423667588780033")
```
...
```{r, echo=FALSE}
embed_tweet("https://twitter.com/_KarenHao/status/1381981018295578629")

embed_tweet("https://twitter.com/JAldrichPL/status/1451524487275552775")
```
