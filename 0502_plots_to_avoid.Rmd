...
```{r echo=FALSE, eval=TRUE,fig.align='middle'}
...
try(include_tweet("https://twitter.com/bmwiernik/status/1362437077820968960"))
```

## Gloriously Terrible Plots!!

```{r, echo=FALSE}
try(include_tweet("https://twitter.com/latentchange/status/1380564902578913287"))
```
