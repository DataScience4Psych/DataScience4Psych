...
```{r welcome-include-1, echo=FALSE,eval = knitr::is_latex_output()}
embed_youtube_alt("7uVbGcBpXU0")
```
```{r welcome-include-2, echo=FALSE,eval = knitr::is_html_output()}
...
```{r welcome-include-3, echo=FALSE,error=TRUE}
...
```{r welcome-include-4, echo=FALSE}
...
```{r welcome-include-5, echo=FALSE,eval = knitr::is_latex_output()}
embed_youtube_alt("jbkSRLYSojo")
```
```{r welcome-include-6, echo=FALSE,eval = knitr::is_html_output()}
...
```{r welcome-include-7, echo=FALSE,eval = knitr::is_latex_output()}
embed_youtube_alt("hVimVzgtD6w")
```
```{r welcome-include-8, echo=FALSE,eval = knitr::is_html_output()}
...
```{r welcome-include-9, echo=FALSE}
...
```{r welcome-include-10, echo=FALSE,eval = knitr::is_latex_output()}
embed_youtube_alt("3mz3HNyew-s")
```
```{r welcome-include-11, echo=FALSE,eval = knitr::is_html_output()}
...
```{r welcome-include-12, echo=FALSE}
