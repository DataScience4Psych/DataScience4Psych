...
embed_url("https://www.youtube.com/watch?v=SJaQtRLFb-Y&list=PLKrrdtYgOUYao_7t5ycK4KDXNKaY-ECup") %>%
  use_align("center")
```
You can follow along with the slides [here][d02-toolkit] if they do not appear below. I recommend installing [R, Rstudio](#install), [git, and github](#installgit) before starting [activity 02](#bechdal)

```{r, echo=FALSE}
var_url="https://datascience4psych.github.io/slides/d02-toolkit/d02-toolkit.html"
...
```{r, echo=FALSE}
var_url="https://datascience4psych.github.io/slides/d02-toolkit/d02-toolkit#24"
...
You can follow along with the slides [here][d02-toolkit] if they do not appear below.

```{r, echo=FALSE}
var_url="https://datascience4psych.github.io/slides/d02-toolkit/d02-toolkit#26"
...
```{r, echo=FALSE}
var_url="https://datascience4psych.github.io/slides/d02-toolkit/d02-toolkit#30"
