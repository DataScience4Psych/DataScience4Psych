...
Go to the course GitHub organization and locate the [template](https://github.com/DataScience4Psych/lab07_betterviz). Clone it in RStudio and open the R Markdown document. 
