...
```{r lab_hellor-setup, include = FALSE}
source("common.R")
```
...
```{r display-clone-repo-screenshot, fig.margin = TRUE, echo = FALSE, fig.width=3}
...
```{r display-create-from-template, fig.margin = TRUE, echo = FALSE, fig.width=3}
...
```{r display-new-repo-copy, fig.margin = TRUE, echo = FALSE, fig.width=3}
knitr::include_graphics("img/newcopylab1.png")
```

* Now we need to connect your new git repo with your computer.

```{r display-get-repo-url, fig.margin = TRUE, echo = FALSE, fig.width=3}
...
```{r display-github-desktop-icon, eval=TRUE, fig.margin = TRUE, echo = FALSE, fig.width=3}
...
```{r display-browser-repo, eval=TRUE, fig.margin = TRUE, echo = FALSE, fig.width=3}

knitr::include_graphics("img/broswer_lab1.png")
...
```{r clone, fig.margin = TRUE, echo = FALSE, fig.width=3}
knitr::include_graphics("img/geturllab01.png")
```
...
```{r display-desktop-clone-path, eval=TRUE, fig.margin = TRUE, echo = FALSE, fig.width=3}
knitr::include_graphics("img/githubdesktop_lab1.png")
```
...
```{r display-github-icon-screenshot, eval=TRUE, fig.margin = TRUE, echo = FALSE, fig.width=3}
knitr::include_graphics("img/g1.png")
```
...
```{r display-new-repo-button, eval=TRUE, fig.margin = TRUE, echo = FALSE, fig.width=3}
...
```{r display-add-template, eval=TRUE, fig.margin = TRUE, echo = FALSE, fig.width=3}
knitr::include_graphics("img/g3.png")
```

In this case, the template is DataScience4Psych/lab-02-plastic-waste

```{r display-template-search, eval=TRUE, fig.margin = TRUE, echo = FALSE, fig.width=3}
knitr::include_graphics("img/g4.png")
```

You can create this repository.

```{r display-create-repo, eval=TRUE, fig.margin = TRUE, echo = FALSE, fig.width=3}
...
```{r display-code-button, eval=TRUE, fig.margin = TRUE, echo = FALSE, fig.width=3}
knitr::include_graphics("img/g6.png")
```

Click Open GitHub Desktop

```{r display-open-desktop, eval=TRUE, fig.margin = TRUE, echo = FALSE, fig.width=3}
...
```{r display-clone-dialog, eval=TRUE, fig.margin = TRUE, echo = FALSE, fig.width=3}
knitr::include_graphics("img/g8.png")
```

Your changes should be automatically reflected in the app.

```{r display-desktop-changes, eval=TRUE, fig.margin = TRUE, echo = FALSE, fig.width=3}
...
```{r display-commit-button, eval=TRUE, fig.margin = TRUE, echo = FALSE, fig.width=3}
