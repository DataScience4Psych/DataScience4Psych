...
```{r lab_hellor-include-1, echo=FALSE}
...
```{r lab_hellor-fig-1, eval=TRUE, fig.margin = TRUE, echo = FALSE, fig.width=3}
...
```{r lab_hellor-fig-2, eval=TRUE, fig.margin = TRUE, echo = FALSE, fig.width=3}
...
```{r lab_hellor-fig-3, eval=TRUE, fig.margin = TRUE, echo = FALSE, fig.width=3}
...
```{r lab_hellor-fig-4, eval=TRUE, fig.margin = TRUE, echo = FALSE, fig.width=3}
knitr::include_graphics("img/g1.png")
```
...
```{r lab_hellor-fig-5, eval=TRUE, fig.margin = TRUE, echo = FALSE, fig.width=3}
...
```{r lab_hellor-fig-6, eval=TRUE, fig.margin = TRUE, echo = FALSE, fig.width=3}
knitr::include_graphics("img/g3.png")
```

In this case, the template is DataScience4Psych/lab-02-plastic-waste

```{r lab_hellor-fig-7, eval=TRUE, fig.margin = TRUE, echo = FALSE, fig.width=3}
knitr::include_graphics("img/g4.png")
```

You can create this repository.

```{r lab_hellor-fig-8, eval=TRUE, fig.margin = TRUE, echo = FALSE, fig.width=3}
...
```{r lab_hellor-fig-9, eval=TRUE, fig.margin = TRUE, echo = FALSE, fig.width=3}
knitr::include_graphics("img/g6.png")
```

Click Open GitHub Desktop

```{r lab_hellor-fig-10, eval=TRUE, fig.margin = TRUE, echo = FALSE, fig.width=3}
...
```{r lab_hellor-fig-11, eval=TRUE, fig.margin = TRUE, echo = FALSE, fig.width=3}
knitr::include_graphics("img/g8.png")
```

Your changes should be automatically reflected in the app.

```{r lab_hellor-fig-12, eval=TRUE, fig.margin = TRUE, echo = FALSE, fig.width=3}
...
```{r lab_hellor-fig-13, eval=TRUE, fig.margin = TRUE, echo = FALSE, fig.width=3}
