...
```{r act_another_hotel-include-1, echo=FALSE}
...
```{r act_another_hotel-include-2, echo=FALSE}
...
```{r act_another_hotel-include-3, echo=FALSE}
# Working with Dates
...
```{r act_another_hotel-include-4, echo=FALSE}
