...
# ODD: Writing and reading files {#import-export}
...
```{r import-preview-csv, echo = FALSE, comment = NA}
"gap_life_exp.csv" %>%
  readLines(n = 6) %>%
  cat(sep = "\n")
```
...
```{r import-embed-vsbuffalo-tweet, echo=FALSE}
...
```{r import-compare-formats, error = TRUE}
...
```{r import-preview-dput, echo = FALSE, comment = NA}
