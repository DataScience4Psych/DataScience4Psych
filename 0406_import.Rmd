...
```{r import-include-7, echo=FALSE}
slide_url(ds4p_urls, "d12_import", "#30") %>%
  include_url(height = "400px")
```

```{r import-include-8, echo=FALSE}
library(tweetrmd)
...
```{r import-include-9, echo = FALSE, comment = NA}
"gap_life_exp.csv" %>%
  readLines(n = 6) %>%
  cat(sep = "\n")
```
...
```{r import-include-9-dup2, echo=FALSE}
...
```{r import-include-10, echo = FALSE, comment = NA}
