...
```{r lab_charts-code-plot, eval=TRUE, fig.width=10}
staff_long %>%
...
```{r lab_charts-example-example, eval=FALSE, fig.width=10}
staff_long %>%
  ggplot(aes(
    x = year,
    y = value,
...
```{r lab_charts-example-dup2-example, eval = FALSE}
Whickham %>%
