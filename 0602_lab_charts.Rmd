...
```{r lab_charts-fig-1, echo=FALSE, fig.fullwidth=TRUE}
...
```{r lab_charts-include-1, echo=FALSE}
staff
```
...
```{r lab_charts-include-2, echo=FALSE}
knitr::include_graphics("img/tidyr-longer-wider.gif")
```

The function has the following arguments:

```{r lab_charts-example-1, eval=FALSE}
pivot_longer(data,
  cols,
  names_to = "name"
)
...
```{r lab_charts-code-3, eval=TRUE, fig.width=10}
staff_long %>%
...
```{r lab_charts-example-2, eval=FALSE, fig.width=10}
staff_long %>%
  ggplot(aes(
    x = year,
    y = value,
...
```{r lab_charts-fig-2, echo=FALSE, fig.fullwidth=TRUE}
...
```{r lab_charts-example-3, eval=FALSE}
?Whickham
library(performance)
...
```{r lab_charts-example-1-dup2, eval = FALSE}
Whickham %>%
...
```{r lab_charts-example-2-dup2, eval = FALSE}
Whickham %>%
