...
```{r, echo=FALSE}
embed_tweet("https://twitter.com/kareem_carr/status/1366565047019982856")

embed_tweet("https://twitter.com/kareem_carr/status/1351338586063458304")

embed_tweet("https://twitter.com/minimaxir/status/1474913997807755268")
```
...
```{r, echo=FALSE}
embed_tweet("https://twitter.com/FrRonconi/status/1358045974451662854")

embed_tweet("https://twitter.com/celestelabedz/status/1481472675864215554")
```
