...
* Activities
  * [Dead Reference](https://samillingworth.itch.io/dead-reference) — a free game that tests whether you can spot a fabricated academic citation
  * Annotated Bibliography
* Lab
  * [Lab](#lab09)

```{r ethics-include-tweet, echo=FALSE}
try_include_tweet("https://twitter.com/ChelseaParlett/status/1377361474952200194")
```

# LEC: Data Science and Ethics

## Module Commentary

```{r ethics-include-video-commentary, echo=FALSE}
#
...
```{r ethics-include-video-misrepresenting, echo=FALSE}
#
...
```{r ethics-include-slides-overview, echo=FALSE}
...
```{r ethics-include-slides-maps, echo=FALSE}
