...
```{r, echo=FALSE}
"https://datascience4psych.github.io/slides/d21_fitting/d21_fitting.html#1" %>%
  include_url(height = "400px")
```
...
```{r, echo=FALSE}
try(include_tweet("https://twitter.com/JoshuaGrubbsPhD/status/1516592721468825607"))

#try(include_tweet("https://twitter.com/bmwiernik/status/1516597519228317701"))

try(include_tweet("https://twitter.com/KMKing_Psych/status/1516598327478865923"))
...
```{r, echo=FALSE}
try(include_tweet("https://twitter.com/SMasonGarrison/status/1387230798332506114"))


try(include_tweet("https://twitter.com/tilok_saha/status/1466017023561912328"))
```
