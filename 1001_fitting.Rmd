...
This module is designed to introduce you to the ideas behind fitting and interpreting models. Please watch the videos and work your way through the notes. You can find the video playlist for this module [here][ds4p-pl-10]. Most of the slides used to make the videos in this module can be found in the [slides repo][ds4p-slides].
...
```{r, echo=FALSE}
var_url="https://datascience4psych.github.io/slides/d21_fitting/d21_fitting.html#2"
include_url(var_url, height = "400px")
```
