...
## Exercise 1: Apparent accuracy {.unnumbered}
...
### 1.1 Fit a logistic regression {.unnumbered}

Fit a logistic regression predicting survival from passenger sex and class as a numeric variable.
...
## Exercise 2: Holding passengers back {.unnumbered}
...
This is the simplest form of honest evaluation. The model never sees the test data during training, so its performance on that set reflects genuine predictive ability — not memory.
...
### 2.1 Fit the model on training data only {.unnumbered}
