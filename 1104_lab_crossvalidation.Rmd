...
<details>
  <summary>Click for a solution</summary>
```{r ref.label = "exercise-3-solution.4solution", echo = TRUE, warning = FALSE, message=FALSE}
```
</details>
...
<details>
  <summary>Click for a solution</summary>
```{r ref.label = "exercise-4-solution.2solution", echo = TRUE, warning = FALSE, message=FALSE}
```
</details>
...
titanic_cv51 <- titanic3 %>%
  ...
  filter(!is.na(sex)) %>%
  filter(!is.na(pclass)) %>%
  filter(!is.na(___))          # your added predictor
...
for (j in 1:10) {
  ...
  m_j     <- glm(survived ~ sex + pclass + ___, data = train_j, family = binomial)
  p_j     <- predict(m_j, newdata = test_j, type = "response")
  yhat_j  <- ifelse(p_j > 0.5, 1, 0)
...
```{r exercise-5-solution.1solution, include=FALSE, echo=FALSE, error=TRUE}
titanic_cv51 <- titanic3 %>%
  filter(!is.na(survived)) %>%
  filter(!is.na(sex)) %>%
  filter(!is.na(pclass)) %>%
...
```{r ref.label = "exercise-5-solution.1solution", echo = TRUE, warning = FALSE, message=FALSE}
```
</details>
...
cv_A <- cv_glm_accuracy(cv_df, formula = ___)
cv_B <- cv_glm_accuracy(cv_df, formula = ___)
...
```{r exercise-5-solution.2solution, include=FALSE, echo=FALSE, error=TRUE}
f_A <- survived ~ sex + pclass
...
<details>
  <summary>Click for a solution example</summary>
```{r ref.label = "exercise-5-solution.2solution", echo = TRUE, warning = FALSE, message=FALSE}
```
</details>
...
<details>
  <summary>Click for a hint</summary>
```{r exercise-7-solution.3-hint, ref.label="exercise-7-solution.3solution", echo=FALSE, error=TRUE}
```
</details>
...
```{r exercise-8-solution.1solution, include=FALSE, echo=FALSE, error=TRUE}
...
<details>
  <summary>Click for a solution</summary>
```{r ref.label = "exercise-8-solution.1solution", echo = TRUE, warning = FALSE, message=FALSE}
```
</details>
...
<details>
  <summary>Click for a solution</summary>
```{r ref.label = "exercise-8-solution.2solution", echo = TRUE, warning = FALSE, message=FALSE}
```
</details>
...
<details>
  <summary>Click for a solution</summary>
```{r ref.label = "exercise-10-solution.1solution", echo = TRUE, warning = FALSE, message=FALSE}
```
</details>
...
<details>
  <summary>Click for a solution</summary>
```{r ref.label = "exercise-10-solution.3solution", echo = TRUE, warning = FALSE, message=FALSE}
```
</details>
