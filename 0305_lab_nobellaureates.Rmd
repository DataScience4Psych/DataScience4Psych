...
library(ggplot2)
library(tidyr)
source("https://github.com/DataScience4Psych/lab-03-nobel-laureates/raw/refs/heads/main/data/update_data.R") %>% suppressWarnings()
...
```{r lab_nobellaureates-include-1, message=FALSE, warning=FALSE, echo=FALSE}
...
```{r lab_nobellaureates-include-2, echo=FALSE}
nobel_living <- nobel %>%
  filter(
    !is.na(country),
    gender != "org",
