...
In January 2017, Buzzfeed published an article on why Nobel laureates show immigration is so important for American science. You can read the article [here](https://www.buzzfeednews.com/article/peteraldhous/immigration-and-science).  The article highlighted that many of the U.S.-based Nobel laureates in the sciences were born outside the U.S., underscoring the importance of immigration for scientific innovation.  In this lab, we will analyze the data related to Nobel laureates to replicate and extend some of the visualizations presented in the article.
