...
```{r lab_rmarkdown-example-1, eval=FALSE}
...
```{r lab_rmarkdown-example-2, eval=FALSE}
...
```{r lab_rmarkdown-example-3, eval=FALSE}
vec_source <- c(
  "introduction.R",
  "quick_reference.R",
...
```{r lab_rmarkdown-example-4, eval=FALSE}
data(iris)
...
```{r lab_rmarkdown-example-5, eval=FALSE}
rmarkdown::render(
...
```{r lab_rmarkdown-example-6, eval=FALSE}
