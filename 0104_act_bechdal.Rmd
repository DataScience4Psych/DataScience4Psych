...
```{r act_bechdal-setup, include = FALSE}
source("common.R")
...
```{r embed-bechdel-activity-slides, echo=FALSE}
...
```{r embed-bechdel-compiled-example, echo=FALSE}
...
# ACT: Oh My Git! Version Control Challenge
