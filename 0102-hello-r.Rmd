...
These labs have been adapted from a series of Rstudio tutorials, created by [Mine Çetinkaya-Rundel](https://en.wikipedia.org/wiki/Mine_%C3%87etinkaya-Rundel). Mine is fantastic; her work is fantastic; and she's just a badass! With that in mind, occasionally, I'll include her video tutorials in these labs. I think it useful to see other people working with R.
...
<div style="width:100%;height:0;padding-bottom:56%;position:relative;"><iframe src="https://giphy.com/embed/SXqw0Vpql4sHX9pCl4" width="100%" height="100%" style="position:absolute" frameBorder="0" class="giphy-embed" allowFullScreen></iframe></div>
