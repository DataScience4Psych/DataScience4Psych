...
```{r fitting-include-1, echo=FALSE,eval = knitr::is_latex_output()}
embed_youtube_alt("BVtVIO08KKE")
```
```{r fitting-include-2, echo=FALSE,eval = knitr::is_html_output()}
"https://www.youtube.com/watch?v=BVtVIO08KKE" %>%
  embed_url() %>%
  use_align("center")
```

```{r fitting-include-3, echo=FALSE}
...
```{r fitting-include-4, echo=FALSE}
...
```{r fitting-include-5, echo=FALSE,eval = knitr::is_latex_output()}
embed_youtube_alt("7056Lt3yUY4")
```
```{r fitting-include-6, echo=FALSE,eval = knitr::is_html_output()}
"https://www.youtube.com/watch?v=7056Lt3yUY4" %>%
  embed_url() %>%
  use_align("center")
```

```{r fitting-include-7, echo=FALSE}
...
```{r fitting-include-8, echo=FALSE,eval = knitr::is_latex_output()}
embed_youtube_alt("tSzwRyO7cNw")
```
```{r fitting-include-9, echo=FALSE,eval = knitr::is_html_output()}
"https://www.youtube.com/watch?v=tSzwRyO7cNw" %>%
  embed_url() %>%
  use_align("center")
```

```{r fitting-include-10, echo=FALSE}
...
```{r fitting-include-11, echo=FALSE,eval = knitr::is_latex_output()}
embed_youtube_alt("xTv1wqNKbHI")
```
```{r fitting-include-12, echo=FALSE,eval = knitr::is_html_output()}
"https://www.youtube.com/watch?v=xTv1wqNKbHI" %>%
  embed_url() %>%
  use_align("center")
```

```{r fitting-include-13, echo=FALSE}
...
```{r fitting-include-14, echo=FALSE,eval = knitr::is_latex_output()}
embed_youtube_alt("SVoazCcAZ-s")
```
```{r fitting-include-15, echo=FALSE,eval = knitr::is_html_output()}
"https://www.youtube.com/watch?v=SVoazCcAZ-s" %>%
  embed_url() %>%
  use_align("center")
```

```{r fitting-include-16, echo=FALSE}
...
```{r fitting-include-17, echo=FALSE}
