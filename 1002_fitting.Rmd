...
```{r fitting-include-video, echo=FALSE,eval = knitr::is_latex_output()}
embed_youtube_alt("BVtVIO08KKE")
```
```{r fitting-include-video, echo=FALSE,eval = knitr::is_html_output()}
"https://www.youtube.com/watch?v=BVtVIO08KKE" %>%
  embed_url() %>%
  use_align("center")
```

```{r fitting-include-slides, echo=FALSE}
...
```{r fitting-code-plot, fig.width = 6}
...
```{r fitting-include-video, echo=FALSE}
