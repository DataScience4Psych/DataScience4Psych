...
#>  [2] <a href="./record/53654?highlight=*:*">Teacup                            ...
#>  [3] <a href="./record/122887?highlight=*:*">Slaughter House                  ...
#>  [4] <a href="./record/20705?highlight=*:*">Riders from the North Frieze of t ...
#>  [5] <a href="./record/99401?highlight=*:*">Untitled - Woman with Bun         ...
#>  [6] <a href="./record/99439?highlight=*:*">Untitled - Woman and Man          ...
#>  [7] <a href="./record/22532?highlight=*:*">Ship in Dry Dock                  ...
#>  [8] <a href="./record/122805?highlight=*:*">The Sofa                         ...
#>  [9] <a href="./record/113745?highlight=*:*">In the Garden                    ...
#> [10] <a href="./record/122835?highlight=*:*">Bathers                          ...
```
...
#>  [2] "Teacup                                    "                                                                                          
#>  [3] "Slaughter House                                                                            (1959)"                                   
#>  [4] "Riders from the North Frieze of the Parthenon                                                                            (1836-1837)"
#>  [5] "Untitled - Woman with Bun                                                                            (1963)"                         
#>  [6] "Untitled - Woman and Man                                                                            (1981)"                          
#>  [7] "Ship in Dry Dock                                    "                                                                                
#>  [8] "The Sofa                                                                            (1950)"                                          
#>  [9] "In the Garden                                                                            (2019)"                                     
#> [10] "Bathers                                                                            (Circa 1959)"
```
...
#>  [1] "./record/20929?highlight=*:*"  "./record/53654?highlight=*:*" 
#>  [3] "./record/122887?highlight=*:*" "./record/20705?highlight=*:*" 
#>  [5] "./record/99401?highlight=*:*"  "./record/99439?highlight=*:*" 
#>  [7] "./record/22532?highlight=*:*"  "./record/122805?highlight=*:*"
#>  [9] "./record/113745?highlight=*:*" "./record/122835?highlight=*:*"
```
