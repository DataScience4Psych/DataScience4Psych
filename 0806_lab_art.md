...
page %>%
  ...
  html_node("h3 a")
#> {xml_nodeset (10)}
#>  [1] <a href="./record/21414?highlight=*:*">Portrait of a Woman               ...
#>  [2] <a href="./record/21847?highlight=*:*">Drawn from Nature Exhibition Post ...
#>  [3] <a href="./record/99925?highlight=*:*">Untitled                          ...
#>  [4] <a href="./record/21669?highlight=*:*">2. (a) Baskerville Serif          ...
#>  [5] <a href="./record/22730?highlight=*:*">Standing Female Nude              ...
#>  [6] <a href="./record/22008?highlight=*:*">Untitled                          ...
#>  [7] <a href="./record/50417?highlight=*:*">Unknown                           ...
#>  [8] <a href="./record/22665?highlight=*:*">Standing Male Nude with White Clo ...
#>  [9] <a href="./record/50497?highlight=*:*">Unknown                           ...
#> [10] <a href="./record/50580?highlight=*:*">Unknown                           ...
```
...
page %>%
  ...
  html_node("h3 a") %>%
  html_text()
#>  [1] "Portrait of a Woman                                                                            (FEB 1952)"               
#>  [2] "Drawn from Nature Exhibition Poster                                                                            (Unknown)"
#>  [3] "Untitled                                                                            (2003)"                              
#>  [4] "2. (a) Baskerville Serif                                                                            (1972)"              
#>  [5] "Standing Female Nude                                    "                                                                
#>  [6] "Untitled                                                                            (1963)"                              
#>  [7] "Unknown                                    "                                                                             
#>  [8] "Standing Male Nude with White Cloth                                    "                                                 
#>  [9] "Unknown                                                                            (1966)"                               
#> [10] "Unknown                                                                            (1949)"
```
...
#>  [1] "./record/21414?highlight=*:*" "./record/21847?highlight=*:*"
#>  [3] "./record/99925?highlight=*:*" "./record/21669?highlight=*:*"
#>  [5] "./record/22730?highlight=*:*" "./record/22008?highlight=*:*"
#>  [7] "./record/50417?highlight=*:*" "./record/22665?highlight=*:*"
#>  [9] "./record/50497?highlight=*:*" "./record/50580?highlight=*:*"
```
