...
page %>%
  ...
  html_node("h3 a")
#> {xml_nodeset (10)}
#>  [1] <a href="./record/100008?highlight=*:*">Curtain                          ...
#>  [2] <a href="./record/21807?highlight=*:*">Unknown                           ...
#>  [3] <a href="./record/21904?highlight=*:*">Unknown                           ...
#>  [4] <a href="./record/113838?highlight=*:*">Book holder                      ...
#>  [5] <a href="./record/123557?highlight=*:*">"Kilns" Longpoint                ...
#>  [6] <a href="./record/22597?highlight=*:*">Couple Near a Window              ...
#>  [7] <a href="./record/21312?highlight=*:*">Abstract Female Nude              ...
#>  [8] <a href="./record/99837?highlight=*:*">Untitled                          ...
#>  [9] <a href="./record/21425?highlight=*:*">Seated Female Nude                ...
#> [10] <a href="./record/21621?highlight=*:*">Untitled                          ...
```
...
#>  [3] "Unknown                                                                            (Unknown)"          
#>  [4] "Book holder                                    "                                                       
#>  [5] "\"Kilns\" Longpoint                                                                            (1949)" 
#>  [6] "Couple Near a Window                                    "                                              
#>  [7] "Abstract Female Nude                                                                            (1965)"
#>  [8] "Untitled                                                                            (1969)"            
#>  [9] "Seated Female Nude                                    "                                                
#> [10] "Untitled                                                                            (Unknown)"
```
...
page %>%
  ...
  html_text() %>%
  str_squish()
#>  [1] "Curtain (1961)"              "Unknown (Unknown)"          
#>  [3] "Unknown (Unknown)"           "Book holder"                
#>  [5] "\"Kilns\" Longpoint (1949)"  "Couple Near a Window"       
#>  [7] "Abstract Female Nude (1965)" "Untitled (1969)"            
#>  [9] "Seated Female Nude"          "Untitled (Unknown)"
```
...
#>  [1] "./record/100008?highlight=*:*" "./record/21807?highlight=*:*" 
#>  [3] "./record/21904?highlight=*:*"  "./record/113838?highlight=*:*"
#>  [5] "./record/123557?highlight=*:*" "./record/22597?highlight=*:*" 
#>  [7] "./record/21312?highlight=*:*"  "./record/99837?highlight=*:*" 
#>  [9] "./record/21425?highlight=*:*"  "./record/21621?highlight=*:*"
```
