...
page %>%
  ...
  html_node("h3 a")
#> {xml_nodeset (10)}
#>  [1] <a href="./record/21203?highlight=*:*">Portrait of a Woman               ...
#>  [2] <a href="./record/99528?highlight=*:*">Untitled                          ...
#>  [3] <a href="./record/53599?highlight=*:*">Unknown                           ...
#>  [4] <a href="./record/21703?highlight=*:*">The Sun Dissolves while Man Looks ...
#>  [5] <a href="./record/21677?highlight=*:*">Northern Highland Landscape       ...
#>  [6] <a href="./record/99482?highlight=*:*">Untitled - City Highrise          ...
#>  [7] <a href="./record/21886?highlight=*:*">Untitled                          ...
#>  [8] <a href="./record/21791?highlight=*:*">Untitled                          ...
#>  [9] <a href="./record/21565?highlight=*:*">Untitled                          ...
#> [10] <a href="./record/21751?highlight=*:*">Boats and Collies                 ...
```
...
page %>%
  ...
  html_node("h3 a") %>%
  html_text()
#>  [1] "Portrait of a Woman                                                                            (1953)"                              
#>  [2] "Untitled                                                                            (1969)"                                         
#>  [3] "Unknown                                    "                                                                                        
#>  [4] "The Sun Dissolves while Man Looks Away from the Unborn Child Mesmerized by the New Technologies                                    "
#>  [5] "Northern Highland Landscape                                                                            (1934)"                      
#>  [6] "Untitled - City Highrise                                                                            (Feb 1962)"                     
#>  [7] "Untitled                                                                            (1989)"                                         
#>  [8] "Untitled                                                                            (2004)"                                         
#>  [9] "Untitled                                                                            (1983-1984)"                                    
#> [10] "Boats and Collies                                                                            (1929)"
```
...
#>  [1] "./record/21203?highlight=*:*" "./record/99528?highlight=*:*"
#>  [3] "./record/53599?highlight=*:*" "./record/21703?highlight=*:*"
#>  [5] "./record/21677?highlight=*:*" "./record/99482?highlight=*:*"
#>  [7] "./record/21886?highlight=*:*" "./record/21791?highlight=*:*"
#>  [9] "./record/21565?highlight=*:*" "./record/21751?highlight=*:*"
```
