...
```{r simulationnotes-code-24, }
letters[1:2]
```

And the last 17 `LETTERS`.

```{r simulationnotes-code-25, }
LETTERS[10:26]
```
...
```{r simulationnotes-code-43, error = TRUE}
data.frame(
  group = rep(LETTERS[3:4], each = 10),
...
```{r simulationnotes-code-50, }
str(simlist)
```

Here is the first one.

```{r simulationnotes-code-51, }
simlist[[1]]
```
