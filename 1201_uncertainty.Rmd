...
```{r uncertainty-include-video, echo=FALSE,eval = knitr::is_latex_output()}
embed_youtube_alt("rQp3knI6Pdk")
```
```{r uncertainty-include-video, echo=FALSE,eval = knitr::is_html_output()}
"https://www.youtube.com/watch?v=rQp3knI6Pdk" %>%
  embed_url() %>%
  use_align("center")
```

```{r uncertainty-include-slides, echo=FALSE}
"https://datascience4psych.github.io/slides/d26_quantify/d26_quantify.html" %>%
  include_url(height = "400px")
```

```{r uncertainty-include-tweet, echo=FALSE}
...
```{r uncertainty-include-video, echo=FALSE}
