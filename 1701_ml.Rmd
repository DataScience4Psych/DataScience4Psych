...
```{r ml-include-video-neural-network, echo=FALSE}
...
```{r ml-include-tweet-neural, echo=FALSE}
...
The following videos by Youtuber and game developer [Dani](https://www.youtube.com/c/DaniDev/about) illustrate the iterative learning process. Specifically, I think his video on "[Teaching A.I. to Play my Game!](https://www.youtube.com/watch?v=JxdcuHXn9dc)" introduces the basic ideas behind neural networks well and shows the dynamic development process. His video on "[Stickman A.I. Learns To Walk
...
```{r ml-include-video-teach-ai, echo=FALSE}
# Teaching A.I. to Play My Game!
...
```{r ml-include-video-stickman, echo=FALSE}
#  Stickman A.I. Learns To Walk
...
```{r ml-include-video-nlp, echo=FALSE}
