...
test_that("Exercise 1 uses inline R code", {
  ...
  expect_true(has_inline,
              label = "Exercise 1 should use inline R code (e.g., `r nrow(data)`)")
})
...
test_that("Exercise 2 uses inline R code", {
  ...
  has_inline <- any(grepl("`r\\s+[^`]+`", section))
  expect_true(has_inline,
              label = "Exercise 2 should use inline R code (e.g., `r nrow(data)`)")
})
...
test_that("Exercise 3 section contains R code", {
  ...
  has_inline <- any(grepl("`r\\s+[^`]+`", section))
  expect_true(has_chunk || has_inline,
              label = "Exercise 3 should contain R code (code chunk or inline R expression)")
})
...
test_that("Exercise 4 section contains R code", {
  ...
  has_inline <- any(grepl("`r\\s+[^`]+`", section))
  expect_true(has_chunk || has_inline,
              label = "Exercise 4 should contain R code (code chunk or inline R expression)")
})
...
test_that("Exercise 6 section contains R code", {
  ...
  has_inline <- any(grepl("`r\\s+[^`]+`", section))
  expect_true(has_chunk || has_inline,
              label = "Exercise 6 should contain R code (code chunk or inline R expression)")
})
