...
- Source: [Wikipedia's Fishing industry by country](https://en.wikipedia.org/wiki/Fishing_industry_by_country)
...
.question[
The (not-so-great) visualization below shows the distribution of fishery harvest  of countries for 2016, by capture and aquaculture. What are some ways you would improve this visualization?]
...
.footnote[
Note: Countries whose total harvest was less than 100,000 tons were excluded in the visualization.
]
--
...
.hand-blue[calculate summary stats at the continent level & visualize them]
...
- (Remember that those were excluded from the original visualization)
...
.your-turn[
- [class git repo](https://github.com/DataScience4Psych) > `AE 05 - Fisheries + Data joins` > open `fisheries.Rmd` and knit.
- Knit the document and work on the Exercises 1 - 4.
]
---
