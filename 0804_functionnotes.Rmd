...
```{r functionnotes-code-data, error = TRUE}
...
```{r functionnotes-code-dup2-demo,error=TRUE}
average_delay_by_airline <- function(data = flights, airline_code, delay_type = "dep_delay") {
...
```{r functionnotes-code-demo, error = TRUE}
...
```{r functionnotes-code-dup2-demo, }
mmm <- function(x) {
...
```{r functionnotes-example-example, eval = FALSE}
