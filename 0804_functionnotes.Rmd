...
```{r start-function-section-1-example}
...
```{r end-function-section-1-example}
mmm2
```
...
```{r start-function-section-2-example}
library(gapminder)
```
...
```{r end-function-section-2-example}
qdiff3
```
...
```{r start-function-section-3-example}
library(gapminder)
```
...
```{r end-function-section-3-example, eval = FALSE}
...
```{r functionnotes-code-dup2-plot, }
