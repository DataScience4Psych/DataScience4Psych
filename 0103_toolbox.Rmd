...
# LEC: Meet our toolbox

```{r meet-toolbox-video-latex, echo=FALSE,eval = knitr::is_latex_output()}
embed_youtube_alt("SJaQtRLFb-Y")
```
```{r meet-toolbox-video-html, echo=FALSE,eval = knitr::is_html_output()}
...
```{r embed-toolkit-slides, echo=FALSE}
slide_url(ds4p_urls, "d02_toolkit") %>%
  include_url(height = "400px")
```

```{r embed-toolkit-slides-learning, echo=FALSE}
slide_url(ds4p_urls, "d02_toolkit","#4") %>%
  include_url(height = "400px")
```
...
```{r install-rstudio-video-latex, echo=FALSE,eval = knitr::is_latex_output()}
embed_youtube_alt("kVIZGCT5p9U")
```
```{r install-rstudio-video-html, echo=FALSE,eval = knitr::is_html_output()}
