...
```{r scraping-include-video, echo=FALSE,eval = knitr::is_latex_output()}
embed_youtube_alt("iy11CqHnfcM")
```
```{r scraping-include-video, echo=FALSE,eval = knitr::is_html_output()}
"https://www.youtube.com/watch?v=iy11CqHnfcM" %>%
  embed_url() %>%
  use_align("center")
```

```{r scraping-include-video, echo=FALSE}
...
```{r scraping-include-slides, echo=FALSE}
