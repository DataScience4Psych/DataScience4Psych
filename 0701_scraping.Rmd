...
# LEC: Scraping the web

You can follow along with the slides [here][d16_webscraping] if you would like to open them full-screen.

```{r scraping-include-video-lecture, echo=FALSE,eval = knitr::is_latex_output()}
embed_youtube_alt("iy11CqHnfcM")
```
```{r scraping-include-video-lecture-html, echo=FALSE,eval = knitr::is_html_output()}
"https://www.youtube.com/watch?v=iy11CqHnfcM" %>%
  embed_url() %>%
  use_align("center")
```

```{r scraping-include-slides-lecture, echo=FALSE}
...
```{r scraping-include-video-selector, echo=FALSE,eval = knitr::is_latex_output()}
embed_youtube_alt("B7tGbfDgx3c")
```
```{r scraping-include-video-selector-html, echo=FALSE,eval = knitr::is_html_output()}
"https://www.youtube.com/watch?v=B7tGbfDgx3c" %>%
  embed_url() %>%
  use_align("center")
```

```{r scraping-include-slides-selector, echo=FALSE}
...
```{r scraping-include-video-imdb, echo=FALSE,eval = knitr::is_latex_output()}
embed_youtube_alt("c0s1Im0Q7rA")
```
```{r scraping-include-video-imdb-html, echo=FALSE,eval = knitr::is_html_output()}
"https://www.youtube.com/watch?v=c0s1Im0Q7rA" %>%
  embed_url() %>%
  use_align("center")
```

```{r scraping-include-slides-imdb, echo=FALSE}
...
```{r scraping-include-slides-activity-intro, echo=FALSE}
slide_url(ds4p_urls, "d16_webscraping", "#28") %>%
  include_url(height = "400px")
```

```{r scraping-include-slides-activity-end, echo=FALSE}
...
```{r scraping-include-tweet, echo=FALSE}
library(tweetrmd)
