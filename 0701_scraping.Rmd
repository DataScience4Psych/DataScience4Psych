...
```{r scraping-include-1, echo=FALSE,eval = knitr::is_latex_output()}
embed_youtube_alt("iy11CqHnfcM")
```
```{r scraping-include-2, echo=FALSE,eval = knitr::is_html_output()}
"https://www.youtube.com/watch?v=iy11CqHnfcM" %>%
  embed_url() %>%
  use_align("center")
```

```{r scraping-include-3, echo=FALSE}
...
```{r scraping-include-4, echo=FALSE,eval = knitr::is_latex_output()}
embed_youtube_alt("B7tGbfDgx3c")
```
```{r scraping-include-5, echo=FALSE,eval = knitr::is_html_output()}
"https://www.youtube.com/watch?v=B7tGbfDgx3c" %>%
  embed_url() %>%
  use_align("center")
```

```{r scraping-include-6, echo=FALSE}
...
```{r scraping-include-7, echo=FALSE,eval = knitr::is_latex_output()}
embed_youtube_alt("c0s1Im0Q7rA")
```
```{r scraping-include-8, echo=FALSE,eval = knitr::is_html_output()}
"https://www.youtube.com/watch?v=c0s1Im0Q7rA" %>%
  embed_url() %>%
  use_align("center")
```

```{r scraping-include-9, echo=FALSE}
...
```{r scraping-include-10, echo=FALSE}
slide_url(ds4p_urls, "d16_webscraping", "#28") %>%
  include_url(height = "400px")
```

```{r scraping-include-11, echo=FALSE}
...
```{r scraping-include-12, echo=FALSE}
library(tweetrmd)
