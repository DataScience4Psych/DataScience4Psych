...
```{r include-github-basics, child = './includes/basicsofgithubandgit.Rmd'}
```
...
```{r include-install-git, child = './includes/installgit.Rmd'}
```

```{r include-install-git-client, child = './includes/installgitclient.Rmd'}
```


## Half the battle {#install-intro}

```{r include-half-battle, child = './includes/halfthebattle.Rmd'}
```


### What is a Git client? Why would you want one?

```{r include-why-git-client, child = './includes/whygitclient.Rmd'}
```

```{r include-install-git-client-video, child = './includes/installgitclient.Rmd'}
```
