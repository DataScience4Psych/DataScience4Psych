...
rnorm(5, mean = 0, sd = 1)
#> [1] -1.524 -0.182 -0.807  0.418  0.535

# Generating five uniform values between 0 and 1
runif(5, min = 0, max = 1)
#> [1] 0.531 0.371 0.361 0.348 0.522
...
#> [1]  1.158 -1.192 -0.197 -1.112 -0.804
```
...
#> [1] -1.2023  1.3325  0.0195 -0.2191 -1.3596
```
...
#> [1] -0.9340  0.0386 -1.6003 -1.3997 -0.1048
```
