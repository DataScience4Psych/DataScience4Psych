...
rnorm(5, mean = 0, sd = 1)
#> [1] -0.791  0.210  0.582  0.876  0.797

# Generating five uniform values between 0 and 1
runif(5, min = 0, max = 1)
#> [1] 0.7425 0.0784 0.8263 0.5886 0.9975
...
#> [1] -1.304 -1.511  0.876  0.258  0.587
```
...
#> [1]  1.522  2.090 -1.115  1.093  0.253
```
...
#> [1] -0.2222 -0.3825 -0.0437 -0.4052 -0.0887
```
