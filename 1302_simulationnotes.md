...
rnorm(5, mean = 0, sd = 1)
#> [1] 1.951 0.480 3.108 0.713 0.564

# Generating five uniform values between 0 and 1
runif(5, min = 0, max = 1)
#> [1] 0.208 0.345 0.453 0.633 0.349
...
#> [1] -0.121  0.576 -0.236  0.981 -1.896
```
...
#> [1] -0.328 -1.013 -0.251  1.347 -0.532
```
...
#> [1]  1.4418 -2.0088 -1.2983  0.0995  0.3950
```
