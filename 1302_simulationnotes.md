...
rnorm(5, mean = 0, sd = 1)
#> [1]  1.569 -0.187  0.700 -0.459 -1.109

# Generating five uniform values between 0 and 1
runif(5, min = 0, max = 1)
#> [1] 0.872 0.647 0.267 0.449 0.961
...
#> [1] -0.7272 -0.0523 -1.6494  1.8299 -0.1713
```
...
#> [1]  1.261 -0.273  1.788  1.301 -0.395
```
...
#> [1] -0.899  1.795 -0.210 -1.078  0.669
```
