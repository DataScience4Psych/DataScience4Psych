...
```{r confounds-include-video, echo=FALSE}
...
```{r confounds-include-video, echo=FALSE,eval = knitr::is_latex_output()}
embed_youtube_alt("OHfk4dbzNBc")
```
```{r confounds-include-video, echo=FALSE,eval = knitr::is_html_output()}
...
```{r confounds-include-slides, echo=FALSE}
