...
```{r, echo=FALSE}
try(include_tweet("https://twitter.com/JkayFlake/status/1475533542302093315"))
```
...
```{r, echo=FALSE}
slide_url(ds4p_urls,"d14_confound","#29") %>%
include_url(height = "400px")
```
...
```{r, echo=FALSE}
try(include_tweet("https://twitter.com/DaphnaHarel/status/1366792094279495685"))
```
