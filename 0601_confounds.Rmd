...
```{r confounds-include-1, echo=FALSE}
...
```{r confounds-include-2, echo=FALSE,eval = knitr::is_latex_output()}
embed_youtube_alt("OHfk4dbzNBc")
```
```{r confounds-include-3, echo=FALSE,eval = knitr::is_html_output()}
"https://www.youtube.com/watch?v=OHfk4dbzNBc" %>%
  embed_url() %>%
  use_align("center")
```

```{r confounds-include-4, echo=FALSE}
...
```{r confounds-include-5, echo=FALSE,eval = knitr::is_latex_output()}
embed_youtube_alt("Fv-yucms7lQ")
```
```{r confounds-include-6, echo=FALSE,eval = knitr::is_html_output()}
"https://www.youtube.com/watch?v=Fv-yucms7lQ" %>%
  embed_url() %>%
  use_align("center")
```

```{r confounds-include-7, echo=FALSE}
...
```{r confounds-include-8, echo=FALSE,eval = knitr::is_latex_output()}
embed_youtube_alt("My68gFE_usU")
```
```{r confounds-include-9, echo=FALSE,eval = knitr::is_html_output()}
"https://www.youtube.com/watch?v=My68gFE_usU" %>%
  embed_url() %>%
  use_align("center")
```

```{r confounds-include-10, echo=FALSE}
...
```{r confounds-include-11, echo=FALSE,eval = knitr::is_latex_output()}
embed_youtube_alt("vVq_G-a6K30")
```
```{r confounds-include-12, echo=FALSE,eval = knitr::is_html_output()}
"https://www.youtube.com/watch?v=vVq_G-a6K30" %>%
  embed_url() %>%
  use_align("center")
```

```{r confounds-include-13, echo=FALSE}
...
```{r confounds-include-14, echo=FALSE}
try_include_tweet("https://twitter.com/DaphnaHarel/status/1366792094279495685")
```

```{r confounds-include-15, echo=FALSE,eval = knitr::is_latex_output()}
embed_youtube_alt("xGP08paoAKI")
```
```{r confounds-include-16, echo=FALSE,eval = knitr::is_html_output()}
"https://www.youtube.com/watch?v=xGP08paoAKI" %>%
  embed_url() %>%
  use_align("center")
```

```{r confounds-include-17, echo=FALSE}
