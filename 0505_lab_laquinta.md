...
<img src="img/mitch-hedgeberg-lqd.jpg" alt="" width="640" />
...
<div class="figure">
<img src="img/dennys-laquinta-sketches/dennys-laquinta-sketches.004.png" alt="Full join of Denny's and La Quinta locations in AK" width="300px" />
<p class="caption">(\#fig:unnamed-chunk-8)Full join of Denny's and La Quinta locations in AK</p>
</div>
...
<div class="figure">
<img src="img/Law-of-haversines.png" alt="[Image Credit](https://commons.wikimedia.org/wiki/File:Law-of-haversines.svg) to [TheOtherJesse](https://commons.wikimedia.org/wiki/User:TheOtherJesse) and [Steven G. Johnson](https://commons.wikimedia.org/wiki/User:Stevenj) via wikimedia commons" width="20%" />
<p class="caption">(\#fig:haversines)[Image Credit](https://commons.wikimedia.org/wiki/File:Law-of-haversines.svg) to [TheOtherJesse](https://commons.wikimedia.org/wiki/User:TheOtherJesse) and [Steven G. Johnson](https://commons.wikimedia.org/wiki/User:Stevenj) via wikimedia commons</p>
</div>
