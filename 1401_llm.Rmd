...
This module introduces Large Language Models (LLMs) and their applications in data science. We'll explore basic concepts, use cases, ethical considerations, and hands-on applications of LLMs. Video lectures are in development. Once those videos exist, please watch the videos and work your way through the notes. **The videos will start on the next page.**  You will be able to find the video playlist for this module [here][pl_llm]. The slides used to make the videos in this module can be found in the [slides repo][course_slides].
...
* Activities
  * Exploring LLM Capabilities with OpenAI's API (coming soon)
* Lab
  * Coming soon
