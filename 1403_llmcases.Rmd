# LEC: Applications of Large Language Models in Data Science

```{r llmcases-setup, include = FALSE}
source("common.R")
...
```{r llmcases-setup-dup-video, echo=FALSE, include = FALSE}
video_url <- sample_no_surprises(ds4p_funyoutube$funyoutube)
embed_url(video_url) %>%
  use_align("center")
```

```{r llmcases-include-slides, echo=FALSE}
...
```{r llmcases-code-plot, echo = TRUE}
library(tidytext)
library(dplyr)
library(ggplot2)
