...
These questions narrow your search... Otherwise the scope of data is overwhelming.
The wonderful Kathy Shields helped me add a section to the WFU library website to get you started [guides.zsr.wfu.edu/psychology](https://guides.zsr.wfu.edu/psychology). My favorite three places to look for specific datasets are the University of Michigan's Inter-university Consortium for Political and Social Research ([ICPSR](http://icpsr.org)), Harvard's [Dataverse](http://dataverse.harvard.edu/) and the US government's [Data.gov](https://catalog.data.gov/dataset). To give you a sense of scale, ICPSR has approximately 15,000 digitized data sets. Harvard has about 95,000. Data.gov has about 250,000.
...
Data retrieval ranges wildly. It can be as easy as downloading a data set. Or it can be as unwieldly as: 
- Appling for access to the “digitized” dataset on the Dataverse for an econometrics class
...
There is a silver-lining for difficult data retrieval. The more hurdles between you and the data the less likely it is that you’ll be scooped.
...
```{r, echo=FALSE}
try(include_tweet("https://twitter.com/cMadan/status/1392130356988547076"))
```
