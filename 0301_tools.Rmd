...
```{r tools-include-2, echo=FALSE}
slide_url(ds4p_urls, "d07_tidy") %>%
  include_url(height = "400px")
```

## Data structures in R
```{r tools-include-3, echo=FALSE,eval = knitr::is_latex_output()}
embed_youtube_alt("fE2zILoY53Y")
```
```{r tools-include-4, echo=FALSE,eval = knitr::is_html_output()}
# Data structures in R
...
```{r tools-include-6, echo=FALSE,eval = knitr::is_latex_output()}
embed_youtube_alt("XLj1sJWIv84")
```
```{r tools-include-7, echo=FALSE,eval = knitr::is_html_output()}
"https://www.youtube.com/watch?v=XLj1sJWIv84" %>%
  embed_url() %>%
  use_align("center")
```

```{r tools-include-8, echo=FALSE}
