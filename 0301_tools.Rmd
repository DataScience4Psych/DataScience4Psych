...
```{r tidydata-video-html, echo=FALSE}
# 03.01
...
```{r embed-tidydata-slides, echo=FALSE}
slide_url(ds4p_urls, "d07_tidy") %>%
  include_url(height = "400px")
```

## Data structures in R
```{r datastructures-video-latex, echo=FALSE,eval = knitr::is_latex_output()}
embed_youtube_alt("fE2zILoY53Y")
```
```{r datastructures-video-html, echo=FALSE,eval = knitr::is_html_output()}
# Data structures in R
...
```{r embed-datastructures-slides, echo=FALSE}
slide_url(ds4p_urls, "d07_tidy", "#13") %>%
  include_url(height = "400px")
```

# LEC: Grammar of data wrangling

You can follow along with the slides [here][d08_grammar] if you would like to open them full-screen.

```{r grammar-video-latex, echo=FALSE,eval = knitr::is_latex_output()}
embed_youtube_alt("XLj1sJWIv84")
```
```{r grammar-video-html, echo=FALSE,eval = knitr::is_html_output()}
"https://www.youtube.com/watch?v=XLj1sJWIv84" %>%
  embed_url() %>%
  use_align("center")
```

```{r embed-grammar-slides, echo=FALSE}
...
```{r piping-video-html, echo=FALSE}
# PIPES!
...
```{r embed-piping-slides, echo=FALSE}
slide_url(ds4p_urls, "d08_grammar", "#21") %>%
  include_url(height = "400px")
```
