...
```{r lab_plasticwaste-setup, include = FALSE}
...
```{r lab_plasticwaste-include-1, echo=FALSE, eval=TRUE}
...
```{r lab_plasticwaste-include-2, echo=FALSE, message=FALSE, eval=TRUE, warning=FALSE}
plastic_waste %>%
...
```{r lab_plasticwaste-include-3, echo=FALSE, eval=TRUE}
