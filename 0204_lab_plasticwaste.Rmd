...
```{r show-repo-begin, echo=FALSE, eval=TRUE}
...
```{r plot-coastal-waste-relationship, echo=FALSE, message=FALSE, eval=TRUE, warning=FALSE}
plastic_waste %>%
...
```{r show-repo-end, echo=FALSE, eval=TRUE}
