# RDD: Introduction to dplyr {#dplyr_intro}
...
```{r load-gapminder, message = FALSE, warning = FALSE}
library(gapminder)
```
...
```{r compare-base-r-filtering, eval = FALSE}
...
```{r demonstrate-fragile-subsetting, eval = FALSE}
...
```{r demonstrate-robust-filtering, eval = FALSE}
