...
```{r, echo=FALSE}
try(include_tweet("https://twitter.com/samuelmehr/status/1437884883590950920"))
```
...
```{r, echo=FALSE}
try(include_tweet("https://twitter.com/JoeHilgard/status/1398692153451290624"))
```

#### Michael Mullarkey

```{r, echo=FALSE}
try(include_tweet("https://twitter.com/mcmullarkey/status/1394769217988268042"))
```
