...
```{r, echo=FALSE}
include_tweet("https://twitter.com/samuelmehr/status/1437884883590950920")
```
...
#### Joe Hilgard
```{r, echo=FALSE}
include_tweet("https://twitter.com/JoeHilgard/status/1398692153451290624")
```

#### Michael Mullarkey
```{r, echo=FALSE}
include_tweet("https://twitter.com/mcmullarkey/status/1394769217988268042")
```
