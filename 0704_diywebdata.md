...
**MOST IMPORTANTLY** confirm that there is NO [rOpenSci package](https://ropensci.org/packages/) and NO API before you [spend hours scraping](https://rpubs.com/aammd/kivascrape) because the website doesn't provide data in a friendly format.  Scraping is brittle and prone to breaking when the website changes.  APIs are much more stable.
