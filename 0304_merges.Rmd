# LEC: Working with multiple data frames

```{r merges-setup, include = FALSE}
source("common.R")
ds4p_urls <- read.csv("./metadata/ds4p_urls.csv")
library(tweetrmd) # ... embedding tweets
```

```{r multipleframes-video-html, echo=FALSE}
...
```{r embed-multipleframes-slides, echo=FALSE}
...
```{r joining-video-html, echo=FALSE}
# Case Studies in Joining
...
```{r embed-joining-slides, echo=FALSE}
