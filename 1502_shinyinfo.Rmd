...
```{r shinyinfo-setup-2, include = FALSE}
source("common.R")
```
...
```{r shinyinfo-fig-1, echo = FALSE, fig.cap = "Shiny run app button", out.width = "93%"}
...
```{r shinyinfo-fig-2, echo = FALSE, fig.cap = "Shiny stop app button", out.width = "93%"}
...
```{r shinyinfo-fig-3, echo = FALSE, out.width = "93%", fig.cap = "Our Shiny app so far"}
...
```{r shinyinfo-fig-4, echo = FALSE, out.width = "93%", fig.cap = "Shiny inputs"}
...
```{r shinyinfo-fig-5, echo = FALSE, out.width = "93%", fig.cap = "Adding inputs to our Shiny app"}
...
```{r shinyinfo-fig-6, echo = FALSE, out.width = "93%", fig.cap = "Adding a plot to our Shiny app"}
...
```{r shinyinfo-fig-7, echo = FALSE, out.width = "93%", fig.cap = "Shiny publish application button"}
