# LEC: All the Shiny things {#shiny-overview}

```{r shinyinfo-setup, include = FALSE}
source("common.R")
...
```{r shinyinfo-setup-config, include = FALSE}
source("common.R")
```
...
```{r shinyinfo-fig-screenshot-runapp, echo = FALSE, fig.cap = "Shiny run app button", out.width = "93%"}
...
```{r shinyinfo-fig-screenshot-stopapp, echo = FALSE, fig.cap = "Shiny stop app button", out.width = "93%"}
...
```{r shinyinfo-fig-screenshot-layout, echo = FALSE, out.width = "93%", fig.cap = "Our Shiny app so far"}
...
```{r shinyinfo-fig-screenshot-inputs, echo = FALSE, out.width = "93%", fig.cap = "Shiny inputs"}
...
```{r shinyinfo-fig-screenshot-addinputs, echo = FALSE, out.width = "93%", fig.cap = "Adding inputs to our Shiny app"}
...
```{r shinyinfo-fig-screenshot-addplot, echo = FALSE, out.width = "93%", fig.cap = "Adding a plot to our Shiny app"}
...
```{r shinyinfo-fig-screenshot-publish, echo = FALSE, out.width = "93%", fig.cap = "Shiny publish application button"}
...
````markdown
`r xfun::file_string('includes/shiny.Rmd')`
````
