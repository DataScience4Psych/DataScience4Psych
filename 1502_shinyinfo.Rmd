...
```{r shinyinfo-fig-screenshot, echo = FALSE, fig.cap = "Shiny run app button", out.width = "93%"}
...
```{r shinyinfo-fig-screenshot, echo = FALSE, fig.cap = "Shiny stop app button", out.width = "93%"}
...
```{r shinyinfo-fig-screenshot, echo = FALSE, out.width = "93%", fig.cap = "Our Shiny app so far"}
...
```{r shinyinfo-fig-screenshot, echo = FALSE, out.width = "93%", fig.cap = "Shiny inputs"}
...
```{r shinyinfo-fig-screenshot, echo = FALSE, out.width = "93%", fig.cap = "Adding inputs to our Shiny app"}
...
```{r shinyinfo-fig-screenshot, echo = FALSE, out.width = "93%", fig.cap = "Adding a plot to our Shiny app"}
...
```{r shinyinfo-fig-screenshot, echo = FALSE, out.width = "93%", fig.cap = "Shiny publish application button"}
...
```{r links-courseinfo, child="admin/md/courselinks.md"}
```

```{r links-courseinfo, child="admin/md/links.md"}
```
