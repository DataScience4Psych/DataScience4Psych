...
* It is hard to modify. What if you later decide you want data for Canada and the US? You have to rewrite the code.
...
This call explains itself and is fairly robust. Future you will thank present you.
...
One of these is clearly easier to read and write! And, with the pipe operator, you can write code in the order you think about the problem.
